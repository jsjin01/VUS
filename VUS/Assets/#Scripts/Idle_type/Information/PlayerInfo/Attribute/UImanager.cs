...
public class UIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        upgradeAttackSpeed100Button.onClick.AddListener(() => playerStats.UpgradeAttackSpeed(100));
        upgradeMoveSpeedButton.onClick.AddListener(() => playerStats.UpgradeMoveSpeed(1));
        upgradeMoveSpeed100Button.onClick.AddListener(() => playerStats.UpgradeMoveSpeed(100));
        upgradePhysicalStrengthButton.onClick.AddListener(() => playerStats.UpgradePhysicalStrength(1));
        upgradePhysicalStrength100Button.onClick.AddListener(() => playerStats.UpgradePhysicalStrength(100));
        upgradeCritChanceButton.onClick.AddListener(() => playerStats.UpgradeCritChance(1));
        upgradeCritChance100Button.onClick.AddListener(() => playerStats.UpgradeCritChance(100));
        upgradeCritDamageButton.onClick.AddListener(() => playerStats.UpgradeCritDamage(1));
        upgradeCritDamage100Button.onClick.AddListener(() => playerStats.UpgradeCritDamage(100));
    }
}